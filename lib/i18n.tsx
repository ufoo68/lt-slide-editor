...
const messages = {
  ja: {
    ...
    aiReview: "ファクトチェック",
    aiReviewMode: "ファクトチェック",
    runAiReview: "ファクトチェック",
    aiReviewing: "確認中...",
    aiReviewEmpty: "Markdown内のテキストを選択して、信ぴょう性をソースURLつきで確認できます。",
    aiReviewFailed: "ファクトチェックに失敗しました",
    aiReviewNotConfigured: "GEMINI_API_KEYが設定されていません",
    aiReviewMinimize: "ファクトチェック欄を最小化",
    aiReviewExpand: "ファクトチェック欄を開く",
    aiReviewBackground: "背景情報（任意）",
    aiReviewBackgroundPlaceholder: "例: この文の「それ」はGemini 2.5 Flashを指す、2026年5月時点の情報として確認したい、など",
    aiReviewSources: "ソース",
    aiReviewCurrentSelection: "現在選択中",
    aiReviewNoSelection: "まだテキストが選択されていません",
    aiReviewSelectedText: "選択したテキスト",
    aiReviewSelectText: "ファクトチェックするテキストをMarkdown内で選択してください",
    aiVerdict: {
      supported: "根拠あり",
      unsupported: "根拠なし",
      mixed: "一部注意",
  ...
  en: {
    ...
    aiReview: "Fact check",
    aiReviewMode: "Fact check",
    runAiReview: "Fact check",
    aiReviewing: "Checking...",
    aiReviewEmpty: "Select text in Markdown to check its credibility with source URLs.",
    aiReviewFailed: "Fact check failed",
    aiReviewNotConfigured: "GEMINI_API_KEY is not configured",
    aiReviewMinimize: "Minimize fact check panel",
    aiReviewExpand: "Open fact check panel",
    aiReviewBackground: "Background (optional)",
    aiReviewBackgroundPlaceholder: "Example: Here, \"it\" means Gemini 2.5 Flash; check this as of May 2026.",
    aiReviewSources: "Sources",
    aiReviewCurrentSelection: "Current selection",
    aiReviewNoSelection: "No text selected yet",
    aiReviewSelectedText: "Selected text",
    aiReviewSelectText: "Select text in Markdown before running a fact check",
    aiVerdict: {
      supported: "Supported",
