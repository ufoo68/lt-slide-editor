...
const messages = {
  ja: {
    ...
    aiAgentSkill: "外部スキル",
    aiAgentSkillPlaceholder: "CodexスキルのSKILL.mdや、スライド作成ルールを貼り付けます。生成時の参考指示として使われます。",
    ...
    deckAgentToken: "Deckトークン",
    deckAgentTokenActive: "外部スキル連携が有効です。トークン本体は発行直後だけ表示されます。",
    deckAgentTokenInactive: "保存済みdeckに限定トークンを発行できます。",
    deckAgentTokenIssueFailed: "Deckトークンを発行できませんでした",
    deckAgentTokenIssued: "Deckトークンを発行しました",
    deckAgentTokenRevokeFailed: "Deckトークンを失効できませんでした",
    deckAgentTokenRevoked: "Deckトークンを失効しました",
    deckAgentTokenSaveFirst: "Deckトークンを発行するには先に保存してください",
    issueDeckAgentToken: "発行",
    revokeDeckAgentToken: "失効",
    close: "閉じる",
  ...
  en: {
    ...
    aiAgentSkill: "External skill",
    aiAgentSkillPlaceholder: "Paste a Codex SKILL.md or slide-generation rules. It will be used as reference guidance for generation.",
    ...
    deckAgentToken: "Deck token",
    deckAgentTokenActive: "External skill access is enabled. The raw token is only shown right after issuing it.",
    deckAgentTokenInactive: "Issue a limited token for this saved deck.",
    deckAgentTokenIssueFailed: "Could not issue the deck token",
    deckAgentTokenIssued: "Issued deck token",
    deckAgentTokenRevokeFailed: "Could not revoke the deck token",
    deckAgentTokenRevoked: "Revoked deck token",
    deckAgentTokenSaveFirst: "Save this deck before issuing a deck token",
    issueDeckAgentToken: "Issue",
    revokeDeckAgentToken: "Revoke",
    close: "Close",
