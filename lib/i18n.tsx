...
const messages = {
  ja: {
    ...
    aiAgent: "AI生成",
    aiAgentDescription: "LT向けのFull Markdownを生成します。現在のデッキも文脈として渡されます。",
    aiAgentPrompt: "作りたいLTの指示",
    aiAgentPromptPlaceholder: "例: Next.js App Routerへの移行でハマった話を7分LTにしたい。導入、失敗例、改善策、まとめを入れて。",
    aiAgentEmpty: "テーマ、対象者、発表時間、入れたいコード例などを書くと、Full Markdownを生成できます。",
    aiAgentFailed: "AI生成に失敗しました",
    aiAgentGenerating: "生成中...",
    aiAgentNotConfigured: "GEMINI_API_KEYが設定されていません",
    aiAgentPromptRequired: "作りたいLTの指示を入力してください",
    runAiAgent: "生成",
    applyGeneratedMarkdown: "Markdownに適用",
    undoGeneratedMarkdown: "元に戻す",
    appliedGeneratedMarkdown: "生成したMarkdownを適用しました",
    close: "閉じる",
  ...
  en: {
    ...
    aiAgent: "AI generate",
    aiAgentDescription: "Generate LT-focused Full Markdown. The current deck is sent as context.",
    aiAgentPrompt: "What should the LT cover?",
    aiAgentPromptPlaceholder: "Example: Create a 7-minute LT about lessons learned migrating to Next.js App Router. Include setup, pitfalls, fixes, and takeaways.",
    aiAgentEmpty: "Describe the topic, audience, duration, and examples you want. The agent will generate Full Markdown.",
    aiAgentFailed: "AI generation failed",
    aiAgentGenerating: "Generating...",
    aiAgentNotConfigured: "GEMINI_API_KEY is not configured",
    aiAgentPromptRequired: "Enter instructions for the LT first",
    runAiAgent: "Generate",
    applyGeneratedMarkdown: "Apply Markdown",
    undoGeneratedMarkdown: "Undo",
    appliedGeneratedMarkdown: "Applied generated Markdown",
    close: "Close",
