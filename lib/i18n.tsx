...
const messages = {
  ja: {
    ...
    aiReview: "Gemini LTレビュー",
    runAiReview: "AIレビュー",
    aiReviewing: "レビュー中...",
    aiReviewEmpty: "Geminiにレビューしてもらうと、時間配分や伝わりやすさの改善案がここに出ます。",
  ...
  en: {
    ...
    aiReview: "Gemini LT review",
    runAiReview: "AI review",
    aiReviewing: "Reviewing...",
    aiReviewEmpty: "Ask Gemini to review timing, clarity, and the deck's takeaway.",
